//////// Customize this data! /////////
//
var startpoint = process.env.startpoint; // Commute starting address
var endpoint = process.env.endpoint; // Commute ending address
var trafficlowthreshold = process.env.trafficlowthreshold; // If traffic adds 3 min. or less to commute, traffic is "low."
var traffichighthreshold = process.env.traffichighthreshold; // If traffic adds 10 min. or more to commute, traffic is "high." If traffic adds between 3 and 10 minutes to commute, traffic is "medium."
var refreshrate = process.env.refreshrate; // Traffic data is updated every 5 minutes.
